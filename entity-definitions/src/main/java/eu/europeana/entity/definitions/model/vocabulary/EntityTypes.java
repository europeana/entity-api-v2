...
public enum EntityTypes implements EntityKeyword {
    ...
    Aggregator("edm", "Aggregator", "http://www.europeana.eu/schemas/edm/Organization"),
     ...
     * @param entityType  Single EntityTypes for which it is verified if it is
     *                    contained in the EntityTypes array
    ...
    /**
     * Identifying agent type by the json value. For user friendliness the the
