...
public interface Organization extends Entity {
    ...
    /**
     * Retrieves the acronym for an Organization Class (language,value) format
     * 
     ...
     * 
     * @param acronym A Map<String,List<List<String>>> for the acronym of an
     ...
     * 
     * @param prefLabel A Map<String,String> of dc descriptions (one per language)
     */
